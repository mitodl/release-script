...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            ...
            [
                ParsedIssue(
                    issue_number=26, org="jlord", repo="sheetsee.js", closes=False
                ),
            ],
        ],
        ...
        [
            ...
            [
                ...
                ParsedIssue(
                    issue_number=94, org="mitodl", repo="mitxpro", closes=False
                ),
                ParsedIssue(
                    issue_number=76, org="mitodl", repo="open-discussions", closes=False
                ),
